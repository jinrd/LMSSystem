...
#### 1. 대시보드 및 학습 현황 (Dashboards)
- [ ] **학생용 대시보드 (Student Dashboard)**: 학생이 본인이 수강 중인 강의 목록과 일정을 확인하는 기능
- [ ] **강사용 대시보드 (Teacher Dashboard)**: 강사가 담당하는 수업 일정과 수강생 목록 등을 확인하는 기능

#### 2. 과제 및 평가 시스템 (Assignments & Grading)
